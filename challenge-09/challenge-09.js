...
(function () {
  ...
  */
  var substraction = calculator(20, 10);
  var multiplication = calculator(4, 20);
  var division = calculator(20,2);
  var mod = calculator(20, 1);
  ...
  chamada.
  */
  console.log( 'O resultado da subtração é:', substraction(function (num1, num2) {
    return num1 - num2;
  }));
